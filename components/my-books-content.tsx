...
export function MyBooksContent({ borrowedBooks, userId }: MyBooksContentProps) {
  ...
  const handleReturn = async (borrowedBook: BorrowedBook & { book: Book | null }) => {
              ...
              currentBooks.map((item) => (
                <div key={item.id} className="flex gap-4 p-4 border border-border rounded-lg">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {/* <p className="text-sm text-muted-foreground">{item.book_author_name}</p> */}
