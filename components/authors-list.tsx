...
import { User, Search, Book, ArrowRight, Loader2 } from "lucide-react"
import Link from "next/link"
import { useGetAuthorsQuery } from "@/lib/redux/services/baserowApi"
        ...
        <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {filteredAuthors.map((author) => (
                    <Link key={author.id} href={`/authors/${author.author_id}`}>
